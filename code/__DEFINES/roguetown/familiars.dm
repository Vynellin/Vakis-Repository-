GLOBAL_LIST_INIT(familiar_types, list(
				...
				"Hollow Antlerling (+1 Fortune)" = /mob/living/simple_animal/pet/familiar/hollow_antlerling,
))

GLOBAL_LIST_INIT(familiar_types_extended, list(
				"Gravemoss Serpent (+1 Strength, +1 Endurance)" = /mob/living/simple_animal/pet/familiar/gravemoss_serpent,
				"Starfield Crow (+1 Perception, +1 Fortune)" = /mob/living/simple_animal/pet/familiar/starfield_crow,
				"Emberdrake (+1 Intelligence, +1 Constitution)" = /mob/living/simple_animal/pet/familiar/emberdrake,
				"Ripplefox (+1 Speed, +1 Fortune)" = /mob/living/simple_animal/pet/familiar/ripplefox,
