...
/*
/obj/effect/proc_holder/spell/invoked/vampire_mistform/cast(list/targets, mob/living/user)
	if(isliving(targets[1]))
		...
		BSDrinker.apply_status_effect(/datum/status_effect/buff/vampire_mistform)
		to_chat(BSDrinker, span_greentext("! MIST FORM !"))
