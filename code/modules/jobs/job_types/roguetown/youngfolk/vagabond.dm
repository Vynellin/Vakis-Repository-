/datum/job/roguetown/vagabond
	...
	tutorial = "Dozens of people end up down on their luck in the Sunmarch every day. They sometimes make something of themselves but much more often die in the streets."
