...
To the outsider, the Tiefling is little more then a lesson in tragedy being written into a bloodline. The corruptive ebb and flow of the broken earth deep below, where the armies of the Underking once marched forward into the material plane, bled into mortal bodies to twist them into a darker reflection of what was once human but no longer is.\
To the privileged few, however, who understand the depths of what it means for a Tiefling to exist-- it is a lesson in redemption greater then any single lifetime. The intermingling of the 'corrupted' and the daemonic, those who had once been in the thrall of the Underking only to break free of his yoke, with the mortal races served to reinforce and stabilize the bloodlines into what is now recognized as a formal 'race'. <br>\
