GLOBAL_LIST_INIT(ziraguard_aggro, world.file2list("strings/rt/drowaggrolines.txt"))
...
/mob/living/carbon/human/species/elf/dark/ziraguard/ambush
	aggressive=1
	wander = TRUE

/mob/living/carbon/human/species/elf/dark/ziraguard/retaliate(mob/living/L)
	var/newtarg = target
	.=..()
	if(target)
		aggressive=1
	...
	if(!is_silent && target != newtarg)
		say(pick(GLOB.ziraguard_aggro))
		linepoint(target)

/mob/living/carbon/human/species/elf/dark/ziraguard/should_target(mob/living/L)
	if(L.stat != CONSCIOUS)
		return FALSE
	. = ..()

/mob/living/carbon/human/species/elf/dark/ziraguard/Initialize()
	. = ..()
...
/mob/living/carbon/human/species/elf/dark/ziraguard/npc_idle()
