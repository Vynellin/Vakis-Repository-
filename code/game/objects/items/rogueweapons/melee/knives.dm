...
/obj/item/rogueweapon/huntingknife/idagger/steel/holysee
	...
	desc = "A mutual effort of Noc and Aeternus' followers, this dagger was forged with both Silver and Gold alike. Blessed to hold strength and bring hope. Whether dae or nite."
	force = 25
	max_integrity = 200
	icon_state = "gsdagger"
