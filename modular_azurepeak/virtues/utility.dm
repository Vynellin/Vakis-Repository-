...
/datum/virtue/utility/resident
	name = "Resident"
	desc = "I'm a resident of Solaris Ridge. I have an account in the city's treasury and a home in the city."
	...
	if(recipient.mind?.assigned_role == "Adventurer" || recipient.mind?.assigned_role == "Mercenary")
		...
		if(spawn_area)
			...
			if(length(possible_chairs))
				...
				to_chat(recipient, span_notice("As a resident of Solaris Ridge, you find yourself seated at a chair in the local tavern."))
			else
...
/datum/virtue/utility/ugly
	name = "Ugly"
	desc = "Be it your family's habits in and out of womb, your own choices or a cruel roll of fate, you have been left unbearable to look at. Stuck to the unseen pits and crevices of the town, you've grown used to the foul odours of life that often follow you. Corpses do not stink for you, and that is all the company you might find."
...
/datum/virtue/utility/bronzearm_r
	...
	custom_text = "Replaces your Right arm with a prosthetic Bronze one. Grants the Trick Arm ability. Incompatible with Wood Arm (R) vice"
...
/datum/virtue/utility/bronzearm_l
	name = "Bronze Arm (L)"
	desc = "Through connections or wealth, my arm had been replaced by one of bronze and gears, that can grip and hold onto things. I've learned just a bit of Engineering as a result."
	custom_text = "Replaces your Left arm with a prosthetic Bronze one. Grants the Trick Arm ability. Incompatible with Wood Arm (L) vice"
	added_skills = list(list(/datum/skill/craft/engineering, 1, 6))
