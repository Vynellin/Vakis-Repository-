/datum/virtue/sucker/lesser_bloodsucker
	...
	custom_text = "Obtain Lesser blood sucker and lower level powers, unable to turn others. if choosen as a blood sucker for that week, obtain +3 extra points. You may be considered a threat, depending on the RP that week"
